...
fileUrl <- "https://www.baseball-reference.com/data/war_daily_pitch.txt"
...
master <- masterLahman[,c("playerID", "bbrefID")]
...
#Reorder data frame
final <- subset(df3, select = c(player_ID, name_common, year_ID, age, team_ID,  stint_ID, lg_ID, G, GS, IPouts, IPouts_start, 
...
write.csv(final, 'war_pitching.csv', row.names = FALSE)
